          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                ...
                <a href="{{ route('student.clas.add') }}" style="float: right" class="btn btn-md btn-rounded btn-success mb-5">Add Student Class</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                          @foreach ($studetnClassData as $key => $student)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $student->name }}</td>
                                <td>
