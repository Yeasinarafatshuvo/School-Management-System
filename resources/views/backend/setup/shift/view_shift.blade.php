          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                ...
                <a href="{{ route('student.shift.add') }}" style="float: right" class="btn btn-md btn-rounded btn-success mb-5">Add Student Shift</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                          @foreach ($studentShiftDetails as $key => $shift)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $shift->name }}</td>
                                <td>
