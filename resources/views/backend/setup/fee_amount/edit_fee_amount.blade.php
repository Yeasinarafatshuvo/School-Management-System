                ...
                <!-- Basic Forms -->
                 <div class="box">
                   ...
                   <div class="box-body">
                     <div class="row">
                       <div class="col">
                           <form action="{{ route('update.fee.amount', $editFeeAmountData[0]->fee_category_id) }}" method="POST">
                            @csrf
                             <div class="row">
                               <div class="col-12">
                                   <div class="add_item">
                                    ...
                                    <div class="controls">
                                            <select name="fee_category_id"  required="" class="form-control">
                                                ...
                                                @foreach ($fee_categories as $category)
                                                    <option value="{{ $category->id }}" {{ ($editFeeAmountData['0']->fee_category_id == $category->id)?"selected":"" }}>{{ $category->name }}</option>
                                                @endforeach                             
                                            </select>
                                    </div>
                                 </div>   {{--end form group --}}
                                 @foreach ($editFeeAmountData as $edit)
                                 <div class="delete_whole_extra_item_add"> {{--start remove data  --}} 
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
