          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                ...
                <a href="{{ route('student.group.add') }}" style="float: right" class="btn btn-md btn-rounded btn-success mb-5">Add Student Group</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                          @foreach ($studentGroupDetails as $key => $group)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $group->name }}</td>
                                <td>
