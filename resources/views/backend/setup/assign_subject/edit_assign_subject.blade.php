                ...
                <!-- Basic Forms -->
                 <div class="box">
                   ...
                   <div class="box-body">
                     <div class="row">
                       <div class="col">
                        <form action="{{ route('update.assign.subject', $editedData[0]->class_id) }}" method="POST">
                            @csrf
                             <div class="row">
                               <div class="col-12">
                                   <div class="add_item">
                                    ...
                                    <div class="controls">
                                            <select name="class_id"  required="" class="form-control">
                                                ...
                                                @foreach ($classes as $class)
                                                    <option value="{{ $class->id }}" {{( $editedData['0']->class_id == $class->id)? "selected":"" }}>{{ $class->name}}</option>
                                                 @endforeach                             
                                            </select>
                                    </div>
                                 </div>   {{--end form group --}}
                                </div>   {{--end form group --}}
                                @foreach ($editedData as $edit)
